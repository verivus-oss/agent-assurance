...
Inspection does not reliably find these. The first audit run showed 25
unprotected checks in a surface that had been inspected repeatedly, and only a
handful had been located that way.
