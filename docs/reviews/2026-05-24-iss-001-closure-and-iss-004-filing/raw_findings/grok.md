...
- **U05-F4 info** — ca50b2c carries no `Reviewed-by:` trailer and was landed by the initiator (Werner Kasselman + Co-Authored-By: agent-model). This is the exact recursive case the review bundle and prompt exist to examine (see Q4).
