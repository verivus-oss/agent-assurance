...
no matter how far the two diverge. Three of the file's own header
comments had also gone stale by 38cd729 and were corrected there; the
comments are documentation, not a gate, and correcting them does not
close this issue.
