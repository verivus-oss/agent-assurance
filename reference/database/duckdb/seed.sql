...
--   50 attribute_vocabulary / 216 attribute_value_allowed
...
INSERT INTO dagtoml.attribute_vocabulary (attribute, applies_to_entity, applies_to_template, ijb_constraint_type, extensible, default_value, layer, backing_enum_type) VALUES
    ...
    ('disclosure_posture',          ['disclosure_attestation'],     NULL, 'policy', FALSE, NULL, 'profile:disclosure', NULL),
    ('redaction_method',            ['redaction'],                  NULL, 'structural', TRUE,  NULL, 'profile:disclosure', NULL),
    ('redaction_reason',            ['redaction'],                  NULL, 'policy', TRUE,  NULL, 'profile:disclosure', NULL),
...
-- attribute_value_allowed (216), identical to postgres/seed.sql.
