...
--   * 216 attribute_value_allowed rows (complete declared catalog,
--                              including native enums and runtime operands)
...
INSERT INTO attribute_vocabulary
    ...
    ('framework_profile_namespace',      NULL, NULL, 'policy', FALSE, NULL, 'core', NULL),
    ...
    ('disclosure_posture',          ARRAY['disclosure_attestation'],     NULL, 'policy', FALSE, NULL, 'profile:disclosure', NULL),
    ('redaction_method',            ARRAY['redaction'],                  NULL, 'structural', TRUE,  NULL, 'profile:disclosure', NULL),
    ('redaction_reason',            ARRAY['redaction'],                  NULL, 'policy', TRUE,  NULL, 'profile:disclosure', NULL),
